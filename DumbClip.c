...
/* $Id: DumbClip.c,v 1.1 1996/02/08 18:11:18 cwikla Exp $ */
/*
...
static void initialize(XmDumbClipWidget _request, XmDumbClipWidget _new, String *_args, Cardinal *_numArgs);
static XtGeometryResult queryGeometry(XmDumbClipWidget _dcw, XtWidgetGeometry *_request, XtWidgetGeometry *_pref);
...
XmDumbClipClassRec xmDumbClipClassRec =
{
	...
	{ /* Composite Part */
		(XtGeometryHandler)XtInheritGeometryManager, /*geometryManager,							 /* geometry_manager */
